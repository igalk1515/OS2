...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      54:	80a080e7          	jalr	-2038(ra) # 585a <exit>
      ...
      74:	8082                	ret
{
      ...
      96:	7c8080e7          	jalr	1992(ra) # 585a <exit>
...
000000000000009a <opentest>:
{
  ...
  if(fd >= 0){
    ...
    exit(1);
      ...
      fc:	762080e7          	jalr	1890(ra) # 585a <exit>
    ...
    exit(1);
     ...
     118:	746080e7          	jalr	1862(ra) # 585a <exit>
...
000000000000011c <truncate2>:
{
  ...
  close(fd2);
    ...
    exit(1);
     ...
     1e0:	67e080e7          	jalr	1662(ra) # 585a <exit>
...
0000000000000264 <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     328:	536080e7          	jalr	1334(ra) # 585a <exit>
     32c:	84ce                	mv	s1,s3
      int cc = write(fd, buf, sz);
     32e:	89aa                	mv	s3,a0
     ...
     34c:	512080e7          	jalr	1298(ra) # 585a <exit>
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     434:	42a080e7          	jalr	1066(ra) # 585a <exit>
     ...
     452:	40c080e7          	jalr	1036(ra) # 585a <exit>
     ...
     470:	3ee080e7          	jalr	1006(ra) # 585a <exit>
      printf("pipe() failed\n");
     ...
     48a:	3d4080e7          	jalr	980(ra) # 585a <exit>
     ...
     4a8:	3b6080e7          	jalr	950(ra) # 585a <exit>
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     594:	2ca080e7          	jalr	714(ra) # 585a <exit>
     ...
     5b2:	2ac080e7          	jalr	684(ra) # 585a <exit>
      printf("pipe() failed\n");
     ...
     5cc:	292080e7          	jalr	658(ra) # 585a <exit>
     ...
     5e6:	278080e7          	jalr	632(ra) # 585a <exit>
     ...
     604:	25a080e7          	jalr	602(ra) # 585a <exit>
...
0000000000000608 <truncate1>:
{
  ...
  close(fd3);
    ...
    exit(1);
     ...
     77a:	0e4080e7          	jalr	228(ra) # 585a <exit>
    printf("aaa fd3=%d\n", fd3);
     77e:	85ca                	mv	a1,s2
    ...
    exit(1);
     ...
     7aa:	0b4080e7          	jalr	180(ra) # 585a <exit>
    printf("bbb fd2=%d\n", fd2);
     7ae:	85a6                	mv	a1,s1
    ...
    exit(1);
     ...
     7da:	084080e7          	jalr	132(ra) # 585a <exit>
    ...
    exit(1);
     ...
     7f8:	066080e7          	jalr	102(ra) # 585a <exit>
    ...
    exit(1);
     ...
     816:	048080e7          	jalr	72(ra) # 585a <exit>
...
000000000000081a <writetest>:
{
  ...
  if(unlink("small") < 0){
    ...
    exit(1);
     ...
     916:	f48080e7          	jalr	-184(ra) # 585a <exit>
     ...
     934:	f2a080e7          	jalr	-214(ra) # 585a <exit>
     ...
     952:	f0c080e7          	jalr	-244(ra) # 585a <exit>
    ...
    exit(1);
     ...
     96e:	ef0080e7          	jalr	-272(ra) # 585a <exit>
    ...
    exit(1);
     ...
     98a:	ed4080e7          	jalr	-300(ra) # 585a <exit>
    ...
    exit(1);
     ...
     9a6:	eb8080e7          	jalr	-328(ra) # 585a <exit>
...
00000000000009aa <writebig>:
{
  ...
  if(fd < 0){
    ...
    exit(1);
     ...
     a72:	dec080e7          	jalr	-532(ra) # 585a <exit>
     ...
     a90:	dce080e7          	jalr	-562(ra) # 585a <exit>
    ...
    exit(1);
     ...
     aac:	db2080e7          	jalr	-590(ra) # 585a <exit>
      if(n == MAXFILE - 1){
  ...
  if(unlink("big") < 0){
     ...
     b04:	d5a080e7          	jalr	-678(ra) # 585a <exit>
     ...
     b22:	d3c080e7          	jalr	-708(ra) # 585a <exit>
     ...
     b40:	d1e080e7          	jalr	-738(ra) # 585a <exit>
    ...
    exit(1);
     ...
     b5c:	d02080e7          	jalr	-766(ra) # 585a <exit>
...
0000000000000b60 <unlinkread>:
{
  ...
  unlink("unlinkread");
    ...
    exit(1);
     ...
     c86:	bd8080e7          	jalr	-1064(ra) # 585a <exit>
    ...
    exit(1);
     ...
     ca2:	bbc080e7          	jalr	-1092(ra) # 585a <exit>
    ...
    exit(1);
     ...
     cbe:	ba0080e7          	jalr	-1120(ra) # 585a <exit>
    ...
    exit(1);
     ...
     cda:	b84080e7          	jalr	-1148(ra) # 585a <exit>
    ...
    exit(1);
     ...
     cf6:	b68080e7          	jalr	-1176(ra) # 585a <exit>
    ...
    exit(1);
     ...
     d12:	b4c080e7          	jalr	-1204(ra) # 585a <exit>
...
0000000000000d16 <linktest>:
{
  ...
  if(link(".", "lf1") >= 0){
    ...
    exit(1);
     ...
     e7e:	9e0080e7          	jalr	-1568(ra) # 585a <exit>
    ...
    exit(1);
     ...
     e9a:	9c4080e7          	jalr	-1596(ra) # 585a <exit>
    ...
    exit(1);
     ...
     eb6:	9a8080e7          	jalr	-1624(ra) # 585a <exit>
    ...
    exit(1);
     ...
     ed2:	98c080e7          	jalr	-1652(ra) # 585a <exit>
    ...
    exit(1);
     ...
     eee:	970080e7          	jalr	-1680(ra) # 585a <exit>
    ...
    exit(1);
     ...
     f0a:	954080e7          	jalr	-1708(ra) # 585a <exit>
    ...
    exit(1);
     ...
     f26:	938080e7          	jalr	-1736(ra) # 585a <exit>
    ...
    exit(1);
     ...
     f42:	91c080e7          	jalr	-1764(ra) # 585a <exit>
    ...
    exit(1);
     ...
     f5e:	900080e7          	jalr	-1792(ra) # 585a <exit>
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    1086:	7d8080e7          	jalr	2008(ra) # 585a <exit>
    ...
    10a6:	7b8080e7          	jalr	1976(ra) # 585a <exit>
    ...
    10c2:	79c080e7          	jalr	1948(ra) # 585a <exit>
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1130:	72e080e7          	jalr	1838(ra) # 585a <exit>
...
pgbug(char *s)
{
  ...
  exit(0);
    ...
    1168:	6f6080e7          	jalr	1782(ra) # 585a <exit>
...
badarg(char *s)
{
  ...
  exit(0);
    ...
    11ae:	6b0080e7          	jalr	1712(ra) # 585a <exit>
...
00000000000011b2 <copyinstr2>:
{
  ...
  int pid = fork();
    ...
    123a:	61c080e7          	jalr	1564(ra) # 5852 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    12be:	5a0080e7          	jalr	1440(ra) # 585a <exit>
    ...
    12de:	580080e7          	jalr	1408(ra) # 585a <exit>
    ...
    12fe:	560080e7          	jalr	1376(ra) # 585a <exit>
    ...
    1320:	53e080e7          	jalr	1342(ra) # 585a <exit>
    ...
    1340:	51e080e7          	jalr	1310(ra) # 585a <exit>
    printf("fork failed\n");
  ...
  if(st != 747){
    ...
    13a4:	4ba080e7          	jalr	1210(ra) # 585a <exit>
...
00000000000013a8 <truncate3>:
{
  ...
  pid = fork();
    ...
    13dc:	47a080e7          	jalr	1146(ra) # 5852 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    145c:	402080e7          	jalr	1026(ra) # 585a <exit>
    ...
    1478:	3e6080e7          	jalr	998(ra) # 585a <exit>
    ...
    1494:	3ca080e7          	jalr	970(ra) # 585a <exit>
    ...
    14b2:	3ac080e7          	jalr	940(ra) # 585a <exit>
  ...
  wait(&xstatus);
    ...
    1508:	35e080e7          	jalr	862(ra) # 5862 <wait>
  unlink("truncfile");
  ...
  exit(xstatus);
    ...
    1524:	33a080e7          	jalr	826(ra) # 585a <exit>
      printf("%s: open failed\n", s);
    1528:	85ca                	mv	a1,s2
    ...
    1540:	31e080e7          	jalr	798(ra) # 585a <exit>
    ...
    155e:	300080e7          	jalr	768(ra) # 585a <exit>
...
0000000000001562 <exectest>:
{
  ...
  pid = fork();
    ...
    15a0:	2b6080e7          	jalr	694(ra) # 5852 <fork>
  if(pid < 0) {
  ...
  if(pid == 0) {
    ...
    15ec:	272080e7          	jalr	626(ra) # 585a <exit>
     printf("%s: fork failed\n", s);
    15f0:	85ca                	mv	a1,s2
    ...
    1608:	256080e7          	jalr	598(ra) # 585a <exit>
    ...
    1624:	23a080e7          	jalr	570(ra) # 585a <exit>
  ...
  if (wait(&xstatus) != pid) {
    ...
    1648:	21e080e7          	jalr	542(ra) # 5862 <wait>
  ...
  if(xstatus != 0)
    ...
    165a:	204080e7          	jalr	516(ra) # 585a <exit>
    ...
    1676:	1e8080e7          	jalr	488(ra) # 585a <exit>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16d0:	18e080e7          	jalr	398(ra) # 585a <exit>
    printf("%s: open failed\n", s);
    16d4:	85ca                	mv	a1,s2
    ...
    16ec:	172080e7          	jalr	370(ra) # 585a <exit>
  unlink("echo-ok");
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1730:	12e080e7          	jalr	302(ra) # 585a <exit>
    exit(0);
    1734:	4501                	li	a0,0
    1736:	00004097          	auipc	ra,0x4
    173a:	124080e7          	jalr	292(ra) # 585a <exit>
...
000000000000173e <pipe1>:
{
  ...
  pid = fork();
    ...
    176a:	0ec080e7          	jalr	236(ra) # 5852 <fork>
    176e:	8a2a                	mv	s4,a0
  if(pid == 0){
    ...
    17f2:	06c080e7          	jalr	108(ra) # 585a <exit>
    close(fds[0]);
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    185c:	002080e7          	jalr	2(ra) # 585a <exit>
    ...
    1878:	fe6080e7          	jalr	-26(ra) # 585a <exit>
    ...
    18c6:	f98080e7          	jalr	-104(ra) # 585a <exit>
    close(fds[0]);
    ...
    18de:	f88080e7          	jalr	-120(ra) # 5862 <wait>
    exit(xstatus);
    18e2:	fa442503          	lw	a0,-92(s0)
    18e6:	00004097          	auipc	ra,0x4
    18ea:	f74080e7          	jalr	-140(ra) # 585a <exit>
    printf("%s: fork() failed\n", s);
    18ee:	85ca                	mv	a1,s2
    ...
    1906:	f58080e7          	jalr	-168(ra) # 585a <exit>
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1926:	f30080e7          	jalr	-208(ra) # 5852 <fork>
    192a:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    193a:	f2c080e7          	jalr	-212(ra) # 5862 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    1978:	ee6080e7          	jalr	-282(ra) # 585a <exit>
    ...
    1994:	eca080e7          	jalr	-310(ra) # 585a <exit>
    ...
    19b0:	eae080e7          	jalr	-338(ra) # 585a <exit>
      exit(i);
    19b4:	854a                	mv	a0,s2
    19b6:	00004097          	auipc	ra,0x4
    19ba:	ea4080e7          	jalr	-348(ra) # 585a <exit>
...
00000000000019be <twochildren>:
{
    ...
    19d4:	e82080e7          	jalr	-382(ra) # 5852 <fork>
    if(pid1 < 0){
    ...
    19e2:	e74080e7          	jalr	-396(ra) # 5852 <fork>
      if(pid2 < 0){
    ...
    19f2:	e74080e7          	jalr	-396(ra) # 5862 <wait>
        wait(0);
    19f6:	4501                	li	a0,0
    19f8:	00004097          	auipc	ra,0x4
    19fc:	e6a080e7          	jalr	-406(ra) # 5862 <wait>
  for(int i = 0; i < 1000; i++){
    ...
    1a28:	e36080e7          	jalr	-458(ra) # 585a <exit>
      exit(0);
    1a2c:	00004097          	auipc	ra,0x4
    1a30:	e2e080e7          	jalr	-466(ra) # 585a <exit>
        printf("%s: fork failed\n", s);
    1a34:	85ca                	mv	a1,s2
    ...
    1a4c:	e12080e7          	jalr	-494(ra) # 585a <exit>
        exit(0);
    1a50:	00004097          	auipc	ra,0x4
    1a54:	e0a080e7          	jalr	-502(ra) # 585a <exit>
...
0000000000001a58 <forkfork>:
{
    ...
    1a68:	dee080e7          	jalr	-530(ra) # 5852 <fork>
    if(pid < 0){
    ...
    1a76:	de0080e7          	jalr	-544(ra) # 5852 <fork>
    if(pid < 0){
    ...
    1a88:	dde080e7          	jalr	-546(ra) # 5862 <wait>
    if(xstatus != 0) {
    ...
    1a9a:	dcc080e7          	jalr	-564(ra) # 5862 <wait>
    if(xstatus != 0) {
    ...
    1ac6:	d98080e7          	jalr	-616(ra) # 585a <exit>
{
    1aca:	0c800493          	li	s1,200
        int pid1 = fork();
    1ace:	00004097          	auipc	ra,0x4
    1ad2:	d84080e7          	jalr	-636(ra) # 5852 <fork>
        if(pid1 < 0){
    ...
    1ae2:	d84080e7          	jalr	-636(ra) # 5862 <wait>
      for(int j = 0; j < 200; j++){
    ...
    1af0:	d6e080e7          	jalr	-658(ra) # 585a <exit>
          exit(1);
    1af4:	4505                	li	a0,1
    1af6:	00004097          	auipc	ra,0x4
    1afa:	d64080e7          	jalr	-668(ra) # 585a <exit>
          exit(0);
    1afe:	00004097          	auipc	ra,0x4
    1b02:	d5c080e7          	jalr	-676(ra) # 585a <exit>
    ...
    1b1e:	d40080e7          	jalr	-704(ra) # 585a <exit>
...
0000000000001b22 <reparent2>:
{
    ...
    1b34:	d22080e7          	jalr	-734(ra) # 5852 <fork>
    if(pid1 < 0){
    ...
    1b44:	d22080e7          	jalr	-734(ra) # 5862 <wait>
  for(int i = 0; i < 800; i++){
  ...
  exit(0);
    ...
    1b52:	d0c080e7          	jalr	-756(ra) # 585a <exit>
      printf("fork failed\n");
    ...
    1b6c:	cf2080e7          	jalr	-782(ra) # 585a <exit>
      fork();
    1b70:	00004097          	auipc	ra,0x4
    1b74:	ce2080e7          	jalr	-798(ra) # 5852 <fork>
      fork();
    1b78:	00004097          	auipc	ra,0x4
    1b7c:	cda080e7          	jalr	-806(ra) # 5852 <fork>
      exit(0);
    1b80:	4501                	li	a0,0
    1b82:	00004097          	auipc	ra,0x4
    1b86:	cd8080e7          	jalr	-808(ra) # 585a <exit>
...
0000000000001b8a <createdelete>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1bae:	ca8080e7          	jalr	-856(ra) # 5852 <fork>
    1bb2:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1bca:	c9c080e7          	jalr	-868(ra) # 5862 <wait>
    if(xstatus != 0)
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c0a:	c54080e7          	jalr	-940(ra) # 585a <exit>
      name[0] = 'p' + pi;
    ...
    1c36:	c28080e7          	jalr	-984(ra) # 585a <exit>
      for(i = 0; i < N; i++){
    ...
    1ca8:	bb6080e7          	jalr	-1098(ra) # 585a <exit>
      exit(0);
    1cac:	4501                	li	a0,0
    1cae:	00004097          	auipc	ra,0x4
    1cb2:	bac080e7          	jalr	-1108(ra) # 585a <exit>
      exit(1);
    1cb6:	4505                	li	a0,1
    1cb8:	00004097          	auipc	ra,0x4
    1cbc:	ba2080e7          	jalr	-1118(ra) # 585a <exit>
    ...
    1cdc:	b82080e7          	jalr	-1150(ra) # 585a <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1d42:	b1c080e7          	jalr	-1252(ra) # 585a <exit>
  for(i = 0; i < N; i++){
...
0000000000001db0 <linkunlink>:
{
  ...
  pid = fork();
    ...
    1de0:	a76080e7          	jalr	-1418(ra) # 5852 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e32:	a2c080e7          	jalr	-1492(ra) # 585a <exit>
  ...
  if(pid)
    ...
    1e8a:	9dc080e7          	jalr	-1572(ra) # 5862 <wait>
}
    ...
    1eae:	9b0080e7          	jalr	-1616(ra) # 585a <exit>
...
0000000000001eb2 <manywrites>:
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    1ed2:	984080e7          	jalr	-1660(ra) # 5852 <fork>
    1ed6:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    1ef2:	974080e7          	jalr	-1676(ra) # 5862 <wait>
    if(st != 0)
  ...
  exit(0);
    ...
    1f06:	958080e7          	jalr	-1704(ra) # 585a <exit>
      printf("fork failed\n");
    ...
    1f20:	93e080e7          	jalr	-1730(ra) # 585a <exit>
      name[0] = 'b';
    ...
    1fb0:	8ae080e7          	jalr	-1874(ra) # 585a <exit>
    ...
    1fd0:	88e080e7          	jalr	-1906(ra) # 585a <exit>
            printf("%s: write(%d) ret %d\n", s, sz, cc);
    1fd4:	86aa                	mv	a3,a0
    ...
    1ff0:	86e080e7          	jalr	-1938(ra) # 585a <exit>
      exit(st);
    1ff4:	00004097          	auipc	ra,0x4
    1ff8:	866080e7          	jalr	-1946(ra) # 585a <exit>
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2016:	840080e7          	jalr	-1984(ra) # 5852 <fork>
    if(pid < 0)
  ...
  for(n=0; n<N; n++){
    ...
    203e:	820080e7          	jalr	-2016(ra) # 585a <exit>
      exit(0);
    2042:	00004097          	auipc	ra,0x4
    2046:	818080e7          	jalr	-2024(ra) # 585a <exit>
  if (n == 0) {
  ...
  for(; n > 0; n--){
    ...
    205e:	808080e7          	jalr	-2040(ra) # 5862 <wait>
  ...
  if(wait(0) != -1){
    ...
    2070:	7f6080e7          	jalr	2038(ra) # 5862 <wait>
    2074:	57fd                	li	a5,-1
    ...
    20a0:	7be080e7          	jalr	1982(ra) # 585a <exit>
    ...
    20bc:	7a2080e7          	jalr	1954(ra) # 585a <exit>
    ...
    20d8:	786080e7          	jalr	1926(ra) # 585a <exit>
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    210a:	74c080e7          	jalr	1868(ra) # 5852 <fork>
    if(pid < 0){
    ...
    211c:	74a080e7          	jalr	1866(ra) # 5862 <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2158:	706080e7          	jalr	1798(ra) # 585a <exit>
    ...
    217a:	6e4080e7          	jalr	1764(ra) # 585a <exit>
      exit(1);
    217e:	4505                	li	a0,1
    2180:	00003097          	auipc	ra,0x3
    2184:	6da080e7          	jalr	1754(ra) # 585a <exit>
...
0000000000002188 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21aa:	6ac080e7          	jalr	1708(ra) # 5852 <fork>
    if(pid < 0){
    ...
    21bc:	6aa080e7          	jalr	1706(ra) # 5862 <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for( ; a != 0; a <<= 1){
    ...
    21fc:	662080e7          	jalr	1634(ra) # 585a <exit>
      *(char*)a = 99;
    ...
    2228:	636080e7          	jalr	1590(ra) # 585a <exit>
      exit(1);
    222c:	4505                	li	a0,1
    222e:	00003097          	auipc	ra,0x3
    2232:	62c080e7          	jalr	1580(ra) # 585a <exit>
...
0000000000002236 <bigargtest>:
{
  ...
  pid = fork();
    ...
    2256:	600080e7          	jalr	1536(ra) # 5852 <fork>
  if(pid == 0){
  ...
  wait(&xstatus);
    ...
    2268:	5fe080e7          	jalr	1534(ra) # 5862 <wait>
  if(xstatus != 0)
  ...
  close(fd);
    ...
    22f8:	566080e7          	jalr	1382(ra) # 585a <exit>
    ...
    2314:	54a080e7          	jalr	1354(ra) # 585a <exit>
    exit(xstatus);
    2318:	00003097          	auipc	ra,0x3
    231c:	542080e7          	jalr	1346(ra) # 585a <exit>
    ...
    2338:	526080e7          	jalr	1318(ra) # 585a <exit>
...
000000000000233c <stacktest>:
{
  ...
  pid = fork();
    ...
    234c:	50a080e7          	jalr	1290(ra) # 5852 <fork>
  if(pid == 0) {
  ...
  wait(&xstatus);
    ...
    235e:	508080e7          	jalr	1288(ra) # 5862 <wait>
  if(xstatus == -1)  // kernel killed child?
    ...
    2370:	4ee080e7          	jalr	1262(ra) # 585a <exit>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2396:	4c8080e7          	jalr	1224(ra) # 585a <exit>
    printf("%s: fork failed\n", s);
    239a:	85a6                	mv	a1,s1
    ...
    23b2:	4ac080e7          	jalr	1196(ra) # 585a <exit>
    exit(0);
    23b6:	4501                	li	a0,0
    23b8:	00003097          	auipc	ra,0x3
    23bc:	4a2080e7          	jalr	1186(ra) # 585a <exit>
...
00000000000023c0 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    248e:	3d0080e7          	jalr	976(ra) # 585a <exit>
    printf("unlink(%s) returned %d, not -1\n", b, ret);
    2492:	862a                	mv	a2,a0
    2494:	85a6                	mv	a1,s1
    ...
    24ac:	3b2080e7          	jalr	946(ra) # 585a <exit>
    printf("open(%s) returned %d, not -1\n", b, fd);
    24b0:	862a                	mv	a2,a0
    24b2:	85a6                	mv	a1,s1
    ...
    24ca:	394080e7          	jalr	916(ra) # 585a <exit>
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
    24ce:	86aa                	mv	a3,a0
    24d0:	8626                	mv	a2,s1
    24d2:	85a6                	mv	a1,s1
    ...
    24ea:	374080e7          	jalr	884(ra) # 585a <exit>
    printf("exec(%s) returned %d, not -1\n", b, fd);
    24ee:	567d                	li	a2,-1
    24f0:	85a6                	mv	a1,s1
    ...
    2508:	356080e7          	jalr	854(ra) # 585a <exit>
...
000000000000250c <rwsbrk>:
{
  ...
  if(n >= 0){
    ...
    2586:	2d8080e7          	jalr	728(ra) # 585a <exit>
    ...
    25a0:	2be080e7          	jalr	702(ra) # 585a <exit>
    ...
    25ba:	2a4080e7          	jalr	676(ra) # 585a <exit>
    ...
    25d4:	28a080e7          	jalr	650(ra) # 585a <exit>
  close(fd);
    25d8:	854a                	mv	a0,s2
  ...
  if(n >= 0){
    ...
    2634:	22a080e7          	jalr	554(ra) # 585a <exit>
    printf("open(rwsbrk) failed\n");
    ...
    264e:	210080e7          	jalr	528(ra) # 585a <exit>
  close(fd);
    2652:	854a                	mv	a0,s2
  ...
  exit(0);
    ...
    2662:	1fc080e7          	jalr	508(ra) # 585a <exit>
...
0000000000002666 <sbrkbasic>:
{
  ...
  pid = fork();
    ...
    267e:	1d8080e7          	jalr	472(ra) # 5852 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    26b6:	1a8080e7          	jalr	424(ra) # 585a <exit>
    ...
    26d0:	18e080e7          	jalr	398(ra) # 585a <exit>
      exit(0);
    26d4:	4501                	li	a0,0
    26d6:	00003097          	auipc	ra,0x3
    26da:	184080e7          	jalr	388(ra) # 585a <exit>
  wait(&xstatus);
    26de:	fbc40513          	addi	a0,s0,-68
    26e2:	00003097          	auipc	ra,0x3
    26e6:	180080e7          	jalr	384(ra) # 5862 <wait>
  if(xstatus == 1){
  ...
  for(i = 0; i < 5000; i++){
    ...
    2724:	13a080e7          	jalr	314(ra) # 585a <exit>
    a = b + 1;
    2728:	84be                	mv	s1,a5
    b = sbrk(1);
    272a:	4505                	li	a0,1
  ...
  pid = fork();
    ...
    274a:	10c080e7          	jalr	268(ra) # 5852 <fork>
    274e:	892a                	mv	s2,a0
  if(pid < 0){
  ...
  if(c != a + 1){
    ...
    2786:	0d8080e7          	jalr	216(ra) # 585a <exit>
    ...
    27a8:	0b6080e7          	jalr	182(ra) # 585a <exit>
...
00000000000027ee <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    290e:	f50080e7          	jalr	-176(ra) # 585a <exit>
    ...
    292a:	f34080e7          	jalr	-204(ra) # 585a <exit>
    ...
    294a:	f14080e7          	jalr	-236(ra) # 585a <exit>
    ...
    296a:	ef4080e7          	jalr	-268(ra) # 585a <exit>
    ...
    2986:	ed8080e7          	jalr	-296(ra) # 585a <exit>
    ...
    29a6:	eb8080e7          	jalr	-328(ra) # 585a <exit>
...
00000000000029aa <sbrkarg>:
{
  ...
  if(pipe((int *) a) != 0){
    ...
    2a46:	e18080e7          	jalr	-488(ra) # 585a <exit>
    ...
    2a62:	dfc080e7          	jalr	-516(ra) # 585a <exit>
    printf("%s: pipe() failed\n", s);
    2a66:	85ce                	mv	a1,s3
    ...
    2a7e:	de0080e7          	jalr	-544(ra) # 585a <exit>
...
0000000000002a82 <argptest>:
{
  ...
  close(fd);
    ...
    2af0:	d6e080e7          	jalr	-658(ra) # 585a <exit>
...
0000000000002af4 <sbrkbugs>:
{
  ...
  int pid = fork();
    ...
    2b00:	d56080e7          	jalr	-682(ra) # 5852 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2b24:	d3a080e7          	jalr	-710(ra) # 585a <exit>
    printf("fork failed\n");
    ...
    2b3e:	d20080e7          	jalr	-736(ra) # 585a <exit>
  wait(0);
    2b42:	4501                	li	a0,0
    2b44:	00003097          	auipc	ra,0x3
    2b48:	d1e080e7          	jalr	-738(ra) # 5862 <wait>
  pid = fork();
    2b4c:	00003097          	auipc	ra,0x3
    2b50:	d06080e7          	jalr	-762(ra) # 5852 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2b7a:	ce4080e7          	jalr	-796(ra) # 585a <exit>
    printf("fork failed\n");
    ...
    2b94:	cca080e7          	jalr	-822(ra) # 585a <exit>
  wait(0);
    2b98:	4501                	li	a0,0
    2b9a:	00003097          	auipc	ra,0x3
    2b9e:	cc8080e7          	jalr	-824(ra) # 5862 <wait>
  pid = fork();
    2ba2:	00003097          	auipc	ra,0x3
    2ba6:	cb0080e7          	jalr	-848(ra) # 5852 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2bda:	c84080e7          	jalr	-892(ra) # 585a <exit>
    printf("fork failed\n");
    ...
    2bf4:	c6a080e7          	jalr	-918(ra) # 585a <exit>
  wait(0);
    2bf8:	4501                	li	a0,0
    2bfa:	00003097          	auipc	ra,0x3
    2bfe:	c68080e7          	jalr	-920(ra) # 5862 <wait>
  exit(0);
    2c02:	4501                	li	a0,0
    2c04:	00003097          	auipc	ra,0x3
    2c08:	c56080e7          	jalr	-938(ra) # 585a <exit>
...
0000000000002c0c <sbrklast>:
{
  ...
  if(p[0] != 'x')
    ...
    2cda:	b84080e7          	jalr	-1148(ra) # 585a <exit>
...
execout(char *s)
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    2d2c:	b2a080e7          	jalr	-1238(ra) # 5852 <fork>
    2d30:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    2d3e:	b28080e7          	jalr	-1240(ra) # 5862 <wait>
  for(int avail = 0; avail < 15; avail++){
  ...
  exit(0);
    ...
    2d4e:	b10080e7          	jalr	-1264(ra) # 585a <exit>
      printf("fork failed\n");
    ...
    2d68:	af6080e7          	jalr	-1290(ra) # 585a <exit>
        if(a == 0xffffffffffffffffLL)
    2d6c:	59fd                	li	s3,-1
        *(char*)(a + 4096 - 1) = 1;
    2d6e:	4a05                	li	s4,1
    ...
    2dd4:	a8a080e7          	jalr	-1398(ra) # 585a <exit>
...
0000000000002dd8 <fourteen>:
{
  ...
  unlink("12345678901234");
    ...
    2eec:	972080e7          	jalr	-1678(ra) # 585a <exit>
    ...
    2f08:	956080e7          	jalr	-1706(ra) # 585a <exit>
    ...
    2f24:	93a080e7          	jalr	-1734(ra) # 585a <exit>
    ...
    2f40:	91e080e7          	jalr	-1762(ra) # 585a <exit>
    ...
    2f5c:	902080e7          	jalr	-1790(ra) # 585a <exit>
    ...
    2f78:	8e6080e7          	jalr	-1818(ra) # 585a <exit>
...
0000000000002f7c <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2ffa:	864080e7          	jalr	-1948(ra) # 585a <exit>
    ...
    3016:	848080e7          	jalr	-1976(ra) # 585a <exit>
    ...
    3032:	82c080e7          	jalr	-2004(ra) # 585a <exit>
    ...
    304e:	810080e7          	jalr	-2032(ra) # 585a <exit>
...
0000000000003052 <exitiputtest>:
{
  ...
  pid = fork();
    ...
    3062:	7f4080e7          	jalr	2036(ra) # 5852 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    30ae:	7b0080e7          	jalr	1968(ra) # 585a <exit>
    printf("%s: fork failed\n", s);
    30b2:	85a6                	mv	a1,s1
    ...
    30ca:	794080e7          	jalr	1940(ra) # 585a <exit>
      printf("%s: mkdir failed\n", s);
    30ce:	85a6                	mv	a1,s1
    ...
    30e6:	778080e7          	jalr	1912(ra) # 585a <exit>
    ...
    3102:	75c080e7          	jalr	1884(ra) # 585a <exit>
      printf("%s: unlink ../iputdir failed\n", s);
    3106:	85a6                	mv	a1,s1
    ...
    311e:	740080e7          	jalr	1856(ra) # 585a <exit>
  wait(&xstatus);
    3122:	fdc40513          	addi	a0,s0,-36
    3126:	00002097          	auipc	ra,0x2
    312a:	73c080e7          	jalr	1852(ra) # 5862 <wait>
  exit(xstatus);
    312e:	fdc42503          	lw	a0,-36(s0)
    3132:	00002097          	auipc	ra,0x2
    3136:	728080e7          	jalr	1832(ra) # 585a <exit>
...
000000000000313a <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    31b8:	6a6080e7          	jalr	1702(ra) # 585a <exit>
    ...
    31d4:	68a080e7          	jalr	1674(ra) # 585a <exit>
    printf("%s: chdir .. failed\n", s);
    31d8:	85a6                	mv	a1,s1
    ...
    31f0:	66e080e7          	jalr	1646(ra) # 585a <exit>
    ...
    320c:	652080e7          	jalr	1618(ra) # 585a <exit>
...
0000000000003210 <subdir>:
{
  ...
  if(unlink("dd") < 0){
    ...
    35e2:	27c080e7          	jalr	636(ra) # 585a <exit>
    ...
    35fe:	260080e7          	jalr	608(ra) # 585a <exit>
    ...
    361a:	244080e7          	jalr	580(ra) # 585a <exit>
    ...
    3636:	228080e7          	jalr	552(ra) # 585a <exit>
    ...
    3652:	20c080e7          	jalr	524(ra) # 585a <exit>
    ...
    366e:	1f0080e7          	jalr	496(ra) # 585a <exit>
    ...
    368a:	1d4080e7          	jalr	468(ra) # 585a <exit>
    ...
    36a6:	1b8080e7          	jalr	440(ra) # 585a <exit>
    ...
    36c2:	19c080e7          	jalr	412(ra) # 585a <exit>
    ...
    36de:	180080e7          	jalr	384(ra) # 585a <exit>
    ...
    36fa:	164080e7          	jalr	356(ra) # 585a <exit>
    ...
    3716:	148080e7          	jalr	328(ra) # 585a <exit>
    ...
    3732:	12c080e7          	jalr	300(ra) # 585a <exit>
    printf("%s: chdir ./.. failed\n", s);
    3736:	85ca                	mv	a1,s2
    ...
    374e:	110080e7          	jalr	272(ra) # 585a <exit>
    ...
    376a:	0f4080e7          	jalr	244(ra) # 585a <exit>
    ...
    3786:	0d8080e7          	jalr	216(ra) # 585a <exit>
    printf("%s: open (unlinked) dd/dd/ff succeeded!\n", s);
    378a:	85ca                	mv	a1,s2
    ...
    37a2:	0bc080e7          	jalr	188(ra) # 585a <exit>
    ...
    37be:	0a0080e7          	jalr	160(ra) # 585a <exit>
    ...
    37da:	084080e7          	jalr	132(ra) # 585a <exit>
    ...
    37f6:	068080e7          	jalr	104(ra) # 585a <exit>
    ...
    3812:	04c080e7          	jalr	76(ra) # 585a <exit>
    ...
    382e:	030080e7          	jalr	48(ra) # 585a <exit>
    ...
    384a:	014080e7          	jalr	20(ra) # 585a <exit>
    ...
    3866:	ff8080e7          	jalr	-8(ra) # 585a <exit>
    ...
    3882:	fdc080e7          	jalr	-36(ra) # 585a <exit>
    ...
    389e:	fc0080e7          	jalr	-64(ra) # 585a <exit>
    ...
    38ba:	fa4080e7          	jalr	-92(ra) # 585a <exit>
    ...
    38d6:	f88080e7          	jalr	-120(ra) # 585a <exit>
    ...
    38f2:	f6c080e7          	jalr	-148(ra) # 585a <exit>
    ...
    390e:	f50080e7          	jalr	-176(ra) # 585a <exit>
    ...
    392a:	f34080e7          	jalr	-204(ra) # 585a <exit>
    ...
    3946:	f18080e7          	jalr	-232(ra) # 585a <exit>
    printf("%s: unlink dd/dd/ff failed\n", s);
    394a:	85ca                	mv	a1,s2
    ...
    3962:	efc080e7          	jalr	-260(ra) # 585a <exit>
    ...
    397e:	ee0080e7          	jalr	-288(ra) # 585a <exit>
    ...
    399a:	ec4080e7          	jalr	-316(ra) # 585a <exit>
    ...
    39b6:	ea8080e7          	jalr	-344(ra) # 585a <exit>
    ...
    39d2:	e8c080e7          	jalr	-372(ra) # 585a <exit>
...
00000000000039d6 <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    3a94:	dca080e7          	jalr	-566(ra) # 585a <exit>
    ...
    3ab0:	dae080e7          	jalr	-594(ra) # 585a <exit>
    printf("%s: rm . worked!\n", s);
    3ab4:	85a6                	mv	a1,s1
    ...
    3acc:	d92080e7          	jalr	-622(ra) # 585a <exit>
    printf("%s: rm .. worked!\n", s);
    3ad0:	85a6                	mv	a1,s1
    ...
    3ae8:	d76080e7          	jalr	-650(ra) # 585a <exit>
    printf("%s: chdir / failed\n", s);
    3aec:	85a6                	mv	a1,s1
    ...
    3b04:	d5a080e7          	jalr	-678(ra) # 585a <exit>
    ...
    3b20:	d3e080e7          	jalr	-706(ra) # 585a <exit>
    printf("%s: unlink dots/.. worked!\n", s);
    3b24:	85a6                	mv	a1,s1
    ...
    3b3c:	d22080e7          	jalr	-734(ra) # 585a <exit>
    ...
    3b58:	d06080e7          	jalr	-762(ra) # 585a <exit>
...
0000000000003b5c <dirfile>:
{
  ...
  close(fd);
    ...
    3c90:	bce080e7          	jalr	-1074(ra) # 585a <exit>
    ...
    3cac:	bb2080e7          	jalr	-1102(ra) # 585a <exit>
    ...
    3cc8:	b96080e7          	jalr	-1130(ra) # 585a <exit>
    printf("%s: create dirfile/xx succeeded!\n", s);
    3ccc:	85ca                	mv	a1,s2
    ...
    3ce4:	b7a080e7          	jalr	-1158(ra) # 585a <exit>
    ...
    3d00:	b5e080e7          	jalr	-1186(ra) # 585a <exit>
    ...
    3d1c:	b42080e7          	jalr	-1214(ra) # 585a <exit>
    ...
    3d38:	b26080e7          	jalr	-1242(ra) # 585a <exit>
    ...
    3d54:	b0a080e7          	jalr	-1270(ra) # 585a <exit>
    ...
    3d70:	aee080e7          	jalr	-1298(ra) # 585a <exit>
    ...
    3d8c:	ad2080e7          	jalr	-1326(ra) # 585a <exit>
...
0000000000003d90 <iref>:
{
    ...
    3de4:	a7a080e7          	jalr	-1414(ra) # 585a <exit>
    ...
    3e00:	a5e080e7          	jalr	-1442(ra) # 585a <exit>
      close(fd);
...
0000000000003eca <openiputtest>:
{
  ...
  pid = fork();
    ...
    3eee:	968080e7          	jalr	-1688(ra) # 5852 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    3f26:	938080e7          	jalr	-1736(ra) # 585a <exit>
    ...
    3f42:	91c080e7          	jalr	-1764(ra) # 585a <exit>
    printf("%s: fork failed\n", s);
    3f46:	85a6                	mv	a1,s1
    ...
    3f5e:	900080e7          	jalr	-1792(ra) # 585a <exit>
    exit(0);
    3f62:	4501                	li	a0,0
    3f64:	00002097          	auipc	ra,0x2
    3f68:	8f6080e7          	jalr	-1802(ra) # 585a <exit>
  sleep(1);
    3f6c:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3fa0:	8be080e7          	jalr	-1858(ra) # 585a <exit>
  wait(&xstatus);
    3fa4:	fdc40513          	addi	a0,s0,-36
    3fa8:	00002097          	auipc	ra,0x2
    3fac:	8ba080e7          	jalr	-1862(ra) # 5862 <wait>
  exit(xstatus);
    3fb0:	fdc42503          	lw	a0,-36(s0)
    3fb4:	00002097          	auipc	ra,0x2
    3fb8:	8a6080e7          	jalr	-1882(ra) # 585a <exit>
...
0000000000003fbc <forkforkfork>:
{
  ...
  int pid = fork();
    ...
    3fdc:	87a080e7          	jalr	-1926(ra) # 5852 <fork>
  if(pid < 0){
  ...
  wait(0);
    ...
    4012:	854080e7          	jalr	-1964(ra) # 5862 <wait>
  sleep(10); // one second
    4016:	4529                	li	a0,10
    ...
    4042:	81c080e7          	jalr	-2020(ra) # 585a <exit>
    ...
    4062:	7f4080e7          	jalr	2036(ra) # 5852 <fork>
    ...
    4088:	7d6080e7          	jalr	2006(ra) # 585a <exit>
...
000000000000408c <killstatus>:
{
    ...
    40a8:	7ae080e7          	jalr	1966(ra) # 5852 <fork>
    40ac:	84aa                	mv	s1,a0
    if(pid1 < 0){
    ...
    40d0:	796080e7          	jalr	1942(ra) # 5862 <wait>
    if(xst != -1) {
  ...
  exit(0);
    ...
    40e8:	776080e7          	jalr	1910(ra) # 585a <exit>
      printf("%s: fork failed\n", s);
    40ec:	85d2                	mv	a1,s4
    ...
    4104:	75a080e7          	jalr	1882(ra) # 585a <exit>
        getpid();
    ...
    412a:	734080e7          	jalr	1844(ra) # 585a <exit>
...
000000000000412e <preempt>:
{
  ...
  pid1 = fork();
    ...
    4144:	712080e7          	jalr	1810(ra) # 5852 <fork>
  if(pid1 < 0) {
  ...
  if(pid1 == 0)
    ...
    416a:	6f4080e7          	jalr	1780(ra) # 585a <exit>
  pid2 = fork();
    416e:	00001097          	auipc	ra,0x1
    4172:	6e4080e7          	jalr	1764(ra) # 5852 <fork>
    4176:	89aa                	mv	s3,a0
  if(pid2 < 0) {
  ...
  if(pid2 == 0)
    ...
    4198:	6c6080e7          	jalr	1734(ra) # 585a <exit>
  pipe(pfds);
  ...
  pid3 = fork();
    ...
    41ac:	6aa080e7          	jalr	1706(ra) # 5852 <fork>
    41b0:	892a                	mv	s2,a0
  if(pid3 < 0) {
  ...
  if(pid3 == 0){
    ...
    4206:	658080e7          	jalr	1624(ra) # 585a <exit>
  ...
  wait(0);
    ...
    42b8:	5ae080e7          	jalr	1454(ra) # 5862 <wait>
  wait(0);
    42bc:	4501                	li	a0,0
    42be:	00001097          	auipc	ra,0x1
    42c2:	5a4080e7          	jalr	1444(ra) # 5862 <wait>
  wait(0);
    42c6:	4501                	li	a0,0
    42c8:	00001097          	auipc	ra,0x1
    42cc:	59a080e7          	jalr	1434(ra) # 5862 <wait>
...
00000000000042d2 <reparent>:
{
  ...
  int master_pid = getpid();
    ...
    42f6:	560080e7          	jalr	1376(ra) # 5852 <fork>
    42fa:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    4308:	55e080e7          	jalr	1374(ra) # 5862 <wait>
  ...
  exit(0);
    ...
    431c:	542080e7          	jalr	1346(ra) # 585a <exit>
      printf("%s: fork failed\n", s);
    4320:	85ce                	mv	a1,s3
    ...
    4338:	526080e7          	jalr	1318(ra) # 585a <exit>
        printf("%s: wait wrong pid\n", s);
    433c:	85ce                	mv	a1,s3
    ...
    4354:	50a080e7          	jalr	1290(ra) # 585a <exit>
      int pid2 = fork();
    4358:	00001097          	auipc	ra,0x1
    435c:	4fa080e7          	jalr	1274(ra) # 5852 <fork>
      if(pid2 < 0){
    4360:	00054763          	bltz	a0,436e <reparent+0x9c>
      exit(0);
    4364:	4501                	li	a0,0
    4366:	00001097          	auipc	ra,0x1
    436a:	4f4080e7          	jalr	1268(ra) # 585a <exit>
        kill(master_pid);
    436e:	8552                	mv	a0,s4
    ...
    437e:	4e0080e7          	jalr	1248(ra) # 585a <exit>
...
0000000000004382 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43ca:	494080e7          	jalr	1172(ra) # 585a <exit>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    4416:	440080e7          	jalr	1088(ra) # 5852 <fork>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    4462:	404080e7          	jalr	1028(ra) # 5862 <wait>
  ...
  pid = fork();
    ...
    4472:	3e4080e7          	jalr	996(ra) # 5852 <fork>
    4476:	84aa                	mv	s1,a0
  if(pid < 0){
  ...
  wait(&xstatus);
    ...
    4486:	3e0080e7          	jalr	992(ra) # 5862 <wait>
  if(xstatus != -1 && xstatus != 2)
    ...
    44c4:	39a080e7          	jalr	922(ra) # 585a <exit>
    printf("%s: fork failed\n", s);
    44c8:	85ca                	mv	a1,s2
    ...
    44e0:	37e080e7          	jalr	894(ra) # 585a <exit>
    a = sbrk(0);
    44e4:	4501                	li	a0,0
    ...
    452c:	332080e7          	jalr	818(ra) # 585a <exit>
    exit(1);
    4530:	4505                	li	a0,1
    4532:	00001097          	auipc	ra,0x1
    4536:	328080e7          	jalr	808(ra) # 585a <exit>
...
000000000000453a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    454e:	308080e7          	jalr	776(ra) # 5852 <fork>
    m1 = 0;
    4552:	4481                	li	s1,0
  ...
  if((pid = fork()) == 0){
    ...
    4598:	2c6080e7          	jalr	710(ra) # 585a <exit>
    ...
    45b4:	2aa080e7          	jalr	682(ra) # 585a <exit>
    wait(&xstatus);
    45b8:	fcc40513          	addi	a0,s0,-52
    45bc:	00001097          	auipc	ra,0x1
    45c0:	2a6080e7          	jalr	678(ra) # 5862 <wait>
    if(xstatus == -1){
    ...
    45d2:	28c080e7          	jalr	652(ra) # 585a <exit>
      exit(0);
    45d6:	4501                	li	a0,0
    45d8:	00001097          	auipc	ra,0x1
    45dc:	282080e7          	jalr	642(ra) # 585a <exit>
...
00000000000045e0 <sharedfd>:
{
  ...
  pid = fork();
    ...
    4626:	230080e7          	jalr	560(ra) # 5852 <fork>
    462a:	89aa                	mv	s3,a0
  ...
  if(pid == 0) {
    ...
    466c:	1f2080e7          	jalr	498(ra) # 585a <exit>
    ...
    4688:	1d6080e7          	jalr	470(ra) # 585a <exit>
    ...
    46a4:	1ba080e7          	jalr	442(ra) # 585a <exit>
    wait(&xstatus);
    46a8:	f9c40513          	addi	a0,s0,-100
    46ac:	00001097          	auipc	ra,0x1
    46b0:	1b6080e7          	jalr	438(ra) # 5862 <wait>
    if(xstatus != 0)
    ...
    46c2:	19c080e7          	jalr	412(ra) # 585a <exit>
  close(fd);
    46c6:	854a                	mv	a0,s2
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4728:	136080e7          	jalr	310(ra) # 585a <exit>
        nc++;
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    478a:	0d4080e7          	jalr	212(ra) # 585a <exit>
    exit(0);
    478e:	4501                	li	a0,0
    4790:	00001097          	auipc	ra,0x1
    4794:	0ca080e7          	jalr	202(ra) # 585a <exit>
...
0000000000004798 <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4804:	052080e7          	jalr	82(ra) # 5852 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4820:	046080e7          	jalr	70(ra) # 5862 <wait>
    if(xstatus != 0)
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    486a:	ff4080e7          	jalr	-12(ra) # 585a <exit>
    ...
    48c8:	f96080e7          	jalr	-106(ra) # 585a <exit>
    ...
    48e4:	f7a080e7          	jalr	-134(ra) # 585a <exit>
    ...
    48fe:	f60080e7          	jalr	-160(ra) # 585a <exit>
      exit(xstatus);
    4902:	00001097          	auipc	ra,0x1
    4906:	f58080e7          	jalr	-168(ra) # 585a <exit>
          printf("wrong char\n", s);
    490a:	85e6                	mv	a1,s9
    ...
    4922:	f3c080e7          	jalr	-196(ra) # 585a <exit>
      total += n;
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49b2:	eac080e7          	jalr	-340(ra) # 585a <exit>
}
...
00000000000049d4 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a56:	e08080e7          	jalr	-504(ra) # 585a <exit>
      link("C0", file);
    ...
    4a74:	dea080e7          	jalr	-534(ra) # 585a <exit>
        exit(1);
    4a78:	4505                	li	a0,1
    4a7a:	00001097          	auipc	ra,0x1
    4a7e:	de0080e7          	jalr	-544(ra) # 585a <exit>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4ad2:	d8c080e7          	jalr	-628(ra) # 585a <exit>
      fa[i] = 1;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b42:	d1c080e7          	jalr	-740(ra) # 585a <exit>
  close(fd);
    4b46:	854a                	mv	a0,s2
  ...
  for(i = 0; i < N; i++){
    ...
    4b7a:	ce4080e7          	jalr	-796(ra) # 585a <exit>
      printf("%s: fork failed\n", s);
    4b7e:	85ce                	mv	a1,s3
    ...
    4b96:	cc8080e7          	jalr	-824(ra) # 585a <exit>
      close(open(file, 0));
    4b9a:	4581                	li	a1,0
    ...
    4c28:	c3e080e7          	jalr	-962(ra) # 5862 <wait>
  for(i = 0; i < N; i++){
    ...
    4c3e:	c18080e7          	jalr	-1000(ra) # 5852 <fork>
    4c42:	892a                	mv	s2,a0
    if(pid < 0){
    ...
    4caa:	bb4080e7          	jalr	-1100(ra) # 585a <exit>
      close(fd);
    ...
    4cc8:	b9e080e7          	jalr	-1122(ra) # 5862 <wait>
      if(xstatus != 0)
  ...
  for(i = 0; i < N; i++){
    ...
    4cf2:	b64080e7          	jalr	-1180(ra) # 5852 <fork>
    if(pid && (i % 3) == 1){
...
0000000000004d2e <bigfile>:
{
  ...
  for(i = 0; ; i++){
    ...
    4e2c:	a32080e7          	jalr	-1486(ra) # 585a <exit>
    ...
    4e48:	a16080e7          	jalr	-1514(ra) # 585a <exit>
    ...
    4e64:	9fa080e7          	jalr	-1542(ra) # 585a <exit>
    ...
    4e80:	9de080e7          	jalr	-1570(ra) # 585a <exit>
    ...
    4e9c:	9c2080e7          	jalr	-1598(ra) # 585a <exit>
    ...
    4eb8:	9a6080e7          	jalr	-1626(ra) # 585a <exit>
  close(fd);
    4ebc:	8552                	mv	a0,s4
  ...
  unlink("bigfile.dat");
    ...
    4f0a:	954080e7          	jalr	-1708(ra) # 585a <exit>
...
00000000000050ae <badwrite>:
{
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5162:	6fc080e7          	jalr	1788(ra) # 585a <exit>
    ...
    517c:	6e2080e7          	jalr	1762(ra) # 585a <exit>
    printf("open junk failed\n");
    ...
    5196:	6c8080e7          	jalr	1736(ra) # 585a <exit>
  close(fd);
    519a:	8526                	mv	a0,s1
  ...
  exit(0);
    ...
    51ba:	6a4080e7          	jalr	1700(ra) # 585a <exit>
...
countfree()
{
  ...
  int pid = fork();
    ...
    51e0:	676080e7          	jalr	1654(ra) # 5852 <fork>
  ...
  if(pid == 0){
    ...
    5244:	61a080e7          	jalr	1562(ra) # 585a <exit>
    printf("pipe() failed in countfree()\n");
    ...
    525e:	600080e7          	jalr	1536(ra) # 585a <exit>
    printf("fork failed in countfree()\n");
    ...
    5278:	5e6080e7          	jalr	1510(ra) # 585a <exit>
      }
    }
    ...
    5282:	5dc080e7          	jalr	1500(ra) # 585a <exit>
  }
  ...
  while(1){
    ...
    52c6:	598080e7          	jalr	1432(ra) # 585a <exit>
  }
  ...
  wait((int*)0);
    ...
    52dc:	58a080e7          	jalr	1418(ra) # 5862 <wait>
...
run(void f(char *), char *s) {
  ...
  if((pid = fork()) < 0) {
    ...
    5314:	542080e7          	jalr	1346(ra) # 5852 <fork>
  ...
  if(pid == 0) {
    ...
    5326:	540080e7          	jalr	1344(ra) # 5862 <wait>
    if(xstatus != 0) 
    ...
    536a:	4f4080e7          	jalr	1268(ra) # 585a <exit>
    f(s);
    536e:	854a                	mv	a0,s2
    5370:	9482                	jalr	s1
    exit(0);
    ...
    5378:	4e6080e7          	jalr	1254(ra) # 585a <exit>
      printf("OK\n");
...
main(int argc, char *argv[])
{
  ...
  if(fail){
    ...
    5454:	40a080e7          	jalr	1034(ra) # 585a <exit>
    5458:	84ae                	mv	s1,a1
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    54aa:	3b4080e7          	jalr	948(ra) # 585a <exit>
          exit(1);
    54ae:	4505                	li	a0,1
    54b0:	00000097          	auipc	ra,0x0
    54b4:	3aa080e7          	jalr	938(ra) # 585a <exit>
    ...
    54d0:	38e080e7          	jalr	910(ra) # 585a <exit>
  for (struct test *t = tests; t->s != 0; t++) {
  ...
  if(fail){
    ...
    5516:	348080e7          	jalr	840(ra) # 585a <exit>
  } else {
    ...
    5530:	32e080e7          	jalr	814(ra) # 585a <exit>
        printf("SOME TESTS FAILED\n");
    5534:	8556                	mv	a0,s5
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    5918:	f66080e7          	jalr	-154(ra) # 587a <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5d70:	b76080e7          	jalr	-1162(ra) # 58e2 <sbrk>
  if(p == (char*)-1)
