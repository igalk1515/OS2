...
go(int which_child)
{
  ...
  if(chdir("grindir") != 0){
    ...
    exit(1);
      ...
      d2:	da0080e7          	jalr	-608(ra) # e6e <exit>
  }
  chdir("/");
  ...
  int fd = -1;
    ...
    if(what == 1){
     ...
     1f2:	c78080e7          	jalr	-904(ra) # e66 <fork>
      if(pid1 == 0){
     ...
     202:	c68080e7          	jalr	-920(ra) # e66 <fork>
      if(pid2 == 0){
     ...
     280:	bfa080e7          	jalr	-1030(ra) # e76 <wait>
      wait(&st2);
     284:	fa840513          	addi	a0,s0,-88
     288:	00001097          	auipc	ra,0x1
     28c:	bee080e7          	jalr	-1042(ra) # e76 <wait>
     ...
     2d8:	b9a080e7          	jalr	-1126(ra) # e6e <exit>
     ...
     356:	b1c080e7          	jalr	-1252(ra) # e6e <exit>
      close(fd);
     35a:	854a                	mv	a0,s2
     ...
     496:	9d4080e7          	jalr	-1580(ra) # e66 <fork>
      if(pid == 0){
     ...
     4a6:	9d4080e7          	jalr	-1580(ra) # e76 <wait>
     4aa:	b9a5                	j	122 <go+0xaa>
        exit(0);
     4ac:	00001097          	auipc	ra,0x1
     4b0:	9c2080e7          	jalr	-1598(ra) # e6e <exit>
        printf("grind: fork failed\n");
     ...
     4ca:	9a8080e7          	jalr	-1624(ra) # e6e <exit>
      int pid = fork();
     4ce:	00001097          	auipc	ra,0x1
     4d2:	998080e7          	jalr	-1640(ra) # e66 <fork>
      if(pid == 0){
     ...
     4e2:	998080e7          	jalr	-1640(ra) # e76 <wait>
     4e6:	b935                	j	122 <go+0xaa>
        fork();
     4e8:	00001097          	auipc	ra,0x1
     4ec:	97e080e7          	jalr	-1666(ra) # e66 <fork>
        fork();
     4f0:	00001097          	auipc	ra,0x1
     4f4:	976080e7          	jalr	-1674(ra) # e66 <fork>
        exit(0);
     4f8:	4501                	li	a0,0
     4fa:	00001097          	auipc	ra,0x1
     4fe:	974080e7          	jalr	-1676(ra) # e6e <exit>
        printf("grind: fork failed\n");
     ...
     518:	95a080e7          	jalr	-1702(ra) # e6e <exit>
      sbrk(6011);
     51c:	6505                	lui	a0,0x1
     ...
     556:	914080e7          	jalr	-1772(ra) # e66 <fork>
     55a:	8b2a                	mv	s6,a0
      if(pid == 0){
     ...
     584:	8f6080e7          	jalr	-1802(ra) # e76 <wait>
     ...
     5ac:	8c6080e7          	jalr	-1850(ra) # e6e <exit>
        printf("grind: fork failed\n");
     ...
     5c6:	8ac080e7          	jalr	-1876(ra) # e6e <exit>
        printf("grind: chdir failed\n");
     ...
     5e0:	892080e7          	jalr	-1902(ra) # e6e <exit>
      int pid = fork();
     5e4:	00001097          	auipc	ra,0x1
     5e8:	882080e7          	jalr	-1918(ra) # e66 <fork>
      if(pid == 0){
     ...
     5f8:	882080e7          	jalr	-1918(ra) # e76 <wait>
     ...
     614:	85e080e7          	jalr	-1954(ra) # e6e <exit>
        printf("grind: fork failed\n");
     ...
     62e:	844080e7          	jalr	-1980(ra) # e6e <exit>
      if(pipe(fds) < 0){
     ...
     646:	824080e7          	jalr	-2012(ra) # e66 <fork>
      if(pid == 0){
     ...
     66e:	80c080e7          	jalr	-2036(ra) # e76 <wait>
     ...
     68a:	7e8080e7          	jalr	2024(ra) # e6e <exit>
        fork();
     68e:	00000097          	auipc	ra,0x0
     692:	7d8080e7          	jalr	2008(ra) # e66 <fork>
        fork();
     696:	00000097          	auipc	ra,0x0
     69a:	7d0080e7          	jalr	2000(ra) # e66 <fork>
     ...
     6d8:	79a080e7          	jalr	1946(ra) # e6e <exit>
     ...
     716:	75c080e7          	jalr	1884(ra) # e6e <exit>
      int pid = fork();
     71a:	00000097          	auipc	ra,0x0
     71e:	74c080e7          	jalr	1868(ra) # e66 <fork>
      if(pid == 0){
     ...
     72e:	74c080e7          	jalr	1868(ra) # e76 <wait>
     ...
     79e:	6d4080e7          	jalr	1748(ra) # e6e <exit>
        printf("grind: fork failed\n");
     ...
     7b8:	6ba080e7          	jalr	1722(ra) # e6e <exit>
      unlink("c");
     ...
     856:	61c080e7          	jalr	1564(ra) # e6e <exit>
     ...
     870:	602080e7          	jalr	1538(ra) # e6e <exit>
     ...
     88a:	5e8080e7          	jalr	1512(ra) # e6e <exit>
     ...
     8a6:	5cc080e7          	jalr	1484(ra) # e6e <exit>
        printf("grind: fstat reports crazy i-number %d\n", st.ino);
     ...
     8c0:	5b2080e7          	jalr	1458(ra) # e6e <exit>
        fprintf(2, "grind: pipe failed\n");
     ...
     8dc:	596080e7          	jalr	1430(ra) # e6e <exit>
        fprintf(2, "grind: pipe failed\n");
     ...
     8f8:	57a080e7          	jalr	1402(ra) # e6e <exit>
        close(bb[0]);
     ...
     954:	51e080e7          	jalr	1310(ra) # e6e <exit>
        close(aa[1]);
     ...
     9ac:	4c6080e7          	jalr	1222(ra) # e6e <exit>
        fprintf(2, "grind: fork failed\n");
     ...
     9c8:	4aa080e7          	jalr	1194(ra) # e6e <exit>
        close(aa[1]);
     ...
     a14:	45e080e7          	jalr	1118(ra) # e6e <exit>
        close(aa[0]);
     ...
     a58:	41a080e7          	jalr	1050(ra) # e6e <exit>
        close(bb[1]);
     ...
     aa4:	3ce080e7          	jalr	974(ra) # e6e <exit>
        fprintf(2, "grind: fork failed\n");
     ...
     ac0:	3b2080e7          	jalr	946(ra) # e6e <exit>
...
iter()
{
  ...
  int pid1 = fork();
     ...
     af4:	376080e7          	jalr	886(ra) # e66 <fork>
  if(pid1 < 0){
  ...
  if(pid1 == 0){
    ...
    exit(1);
     ...
     b2a:	348080e7          	jalr	840(ra) # e6e <exit>
    exit(0);
  }

  int pid2 = fork();
     b2e:	00000097          	auipc	ra,0x0
     b32:	338080e7          	jalr	824(ra) # e66 <fork>
     b36:	892a                	mv	s2,a0
  if(pid2 < 0){
  ...
  if(pid2 == 0){
    ...
    exit(1);
     ...
     b6c:	306080e7          	jalr	774(ra) # e6e <exit>
    exit(0);
  }
  ...
  wait(&st1);
     ...
     b7e:	2fc080e7          	jalr	764(ra) # e76 <wait>
  if(st1 != 0){
  ...
  wait(&st2);
     ...
     b96:	2e4080e7          	jalr	740(ra) # e76 <wait>

  exit(0);
     b9a:	4501                	li	a0,0
     b9c:	00000097          	auipc	ra,0x0
     ba0:	2d2080e7          	jalr	722(ra) # e6e <exit>
    kill(pid1);
     ba4:	8526                	mv	a0,s1
...
main()
{
  ...
  while(1){
    ...
    int pid = fork();
     ...
     bda:	290080e7          	jalr	656(ra) # e66 <fork>
    if(pid == 0){
    ...
    if(pid > 0){
     ...
     bea:	290080e7          	jalr	656(ra) # e76 <wait>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     f2c:	f66080e7          	jalr	-154(ra) # e8e <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1384:	b76080e7          	jalr	-1162(ra) # ef6 <sbrk>
  if(p == (char*)-1)
