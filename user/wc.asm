...
wc(int fd, char *name)
{
  ...
  fa:	31e080e7          	jalr	798(ra) # 414 <exit>
...
main(int argc, char *argv[])
{
 ...
 15a:	2be080e7          	jalr	702(ra) # 414 <exit>
    wc(0, "");
 ...
 176:	2a2080e7          	jalr	674(ra) # 414 <exit>
      printf("wc: cannot open %s\n", argv[i]);
 17a:	608c                	ld	a1,0(s1)
 ...
 192:	286080e7          	jalr	646(ra) # 414 <exit>
...
putc(int fd, char c)
{
 ...
 4d2:	f66080e7          	jalr	-154(ra) # 434 <write>
}
...
malloc(uint nbytes)
{
 ...
 92a:	b76080e7          	jalr	-1162(ra) # 49c <sbrk>
  if(p == (char*)-1)
