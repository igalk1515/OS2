...
panic(char *s)
{
  ...
  exit(1);
      ...
      76:	d60080e7          	jalr	-672(ra) # dd2 <exit>
...
fork1(void)
{
  ...
  pid = fork();
      ...
      86:	d48080e7          	jalr	-696(ra) # dca <fork>
  if(pid == -1)
      8a:	57fd                	li	a5,-1
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exit(1);
      ...
      da:	cfc080e7          	jalr	-772(ra) # dd2 <exit>
    panic("runcmd");
  ...
  exit(0);
     ...
     118:	cbe080e7          	jalr	-834(ra) # dd2 <exit>
      exit(1);
     11c:	4505                	li	a0,1
     11e:	00001097          	auipc	ra,0x1
     122:	cb4080e7          	jalr	-844(ra) # dd2 <exit>
    close(rcmd->fd);
    ...
    runcmd(rcmd->cmd);
     ...
     164:	c72080e7          	jalr	-910(ra) # dd2 <exit>
    if(fork1() == 0)
    ...
    wait(0);
     ...
     178:	c66080e7          	jalr	-922(ra) # dda <wait>
    runcmd(lcmd->right);
    ...
    wait(0);
     ...
     1d2:	c0c080e7          	jalr	-1012(ra) # dda <wait>
    wait(0);
     1d6:	4501                	li	a0,0
     1d8:	00001097          	auipc	ra,0x1
     1dc:	c02080e7          	jalr	-1022(ra) # dda <wait>
    break;
...
0000000000000a60 <main>:
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    wait(0);
     ...
     aca:	314080e7          	jalr	788(ra) # dda <wait>
  while(getcmd(buf, sizeof(buf)) >= 0){
  ...
  exit(0);
     ...
     b50:	286080e7          	jalr	646(ra) # dd2 <exit>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     e90:	f66080e7          	jalr	-154(ra) # df2 <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12e8:	b76080e7          	jalr	-1162(ra) # e5a <sbrk>
  if(p == (char*)-1)
