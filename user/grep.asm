...
00000000000001ee <main>:
{
 ...
 25a:	2d6080e7          	jalr	726(ra) # 52c <exit>
 ...
 276:	2ba080e7          	jalr	698(ra) # 52c <exit>
    grep(pattern, 0);
 27a:	4581                	li	a1,0
 27c:	8552                	mv	a0,s4
 ...
 28c:	2a4080e7          	jalr	676(ra) # 52c <exit>
 ...
 2aa:	286080e7          	jalr	646(ra) # 52c <exit>
...
putc(int fd, char c)
{
 ...
 5ea:	f66080e7          	jalr	-154(ra) # 54c <write>
}
...
malloc(uint nbytes)
{
 ...
 a42:	b76080e7          	jalr	-1162(ra) # 5b4 <sbrk>
  if(p == (char*)-1)
