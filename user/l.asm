...
user/_l:     file format elf64-littleriscv
...
forktest(void)
{
  ...
  52:	89a98993          	addi	s3,s3,-1894 # 8e8 <malloc+0xf4>
  for(n=0; n<N; n++){
  56:	3e800913          	li	s2,1000
    pid = fork();
  5a:	00000097          	auipc	ra,0x0
  5e:	354080e7          	jalr	852(ra) # 3ae <fork>
  62:	85aa                	mv	a1,a0
    if(pid < 0)
  64:	02054d63          	bltz	a0,9e <forktest+0x70>
    if(pid == 0)
  68:	c515                	beqz	a0,94 <forktest+0x66>
    printf("child pid is %d\n",pid);
  6a:	854e                	mv	a0,s3
  ...
  76:	ff2492e3          	bne	s1,s2,5a <forktest+0x2c>
  }

  if(n == N){
    print("fork claimed to work N times!\n");
  7a:	00001517          	auipc	a0,0x1
  7e:	88650513          	addi	a0,a0,-1914 # 900 <malloc+0x10c>
  82:	00000097          	auipc	ra,0x0
  86:	f7e080e7          	jalr	-130(ra) # 0 <print>
    exit(1);
  8a:	4505                	li	a0,1
  8c:	00000097          	auipc	ra,0x0
  90:	32a080e7          	jalr	810(ra) # 3b6 <exit>
      exit(0);
  94:	4501                	li	a0,0
  96:	00000097          	auipc	ra,0x0
  9a:	320080e7          	jalr	800(ra) # 3b6 <exit>
  if(n == N){
  9e:	3e800793          	li	a5,1000
  a2:	fcf48ce3          	beq	s1,a5,7a <forktest+0x4c>
  }

  for(; n > 0; n--){
  a6:	00905b63          	blez	s1,bc <forktest+0x8e>
    if(wait(0) < 0){
  aa:	4501                	li	a0,0
  ac:	00000097          	auipc	ra,0x0
  b0:	312080e7          	jalr	786(ra) # 3be <wait>
  b4:	02054b63          	bltz	a0,ea <forktest+0xbc>
  for(; n > 0; n--){
  b8:	34fd                	addiw	s1,s1,-1
  ba:	f8e5                	bnez	s1,aa <forktest+0x7c>
  ...
  c6:	57fd                	li	a5,-1
  c8:	02f51e63          	bne	a0,a5,104 <forktest+0xd6>
  ...
  d0:	88450513          	addi	a0,a0,-1916 # 950 <malloc+0x15c>
  ...
  ee:	83650513          	addi	a0,a0,-1994 # 920 <malloc+0x12c>
  f2:	00000097          	auipc	ra,0x0
  f6:	f0e080e7          	jalr	-242(ra) # 0 <print>
      exit(1);
  fa:	4505                	li	a0,1
  fc:	00000097          	auipc	ra,0x0
 100:	2ba080e7          	jalr	698(ra) # 3b6 <exit>
    print("wait got too many\n");
 104:	00001517          	auipc	a0,0x1
 108:	83450513          	addi	a0,a0,-1996 # 938 <malloc+0x144>
 10c:	00000097          	auipc	ra,0x0
 110:	ef4080e7          	jalr	-268(ra) # 0 <print>
    exit(1);
 114:	4505                	li	a0,1
 116:	00000097          	auipc	ra,0x0
 11a:	2a0080e7          	jalr	672(ra) # 3b6 <exit>
...
main(void)
{
 ...
 12a:	f08080e7          	jalr	-248(ra) # 2e <forktest>
  exit(0);
 12e:	4501                	li	a0,0
 130:	00000097          	auipc	ra,0x0
 134:	286080e7          	jalr	646(ra) # 3b6 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a6:	4c650513          	addi	a0,a0,1222 # 968 <digits>
 4aa:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 572:	3fab8b93          	addi	s7,s7,1018 # 968 <digits>
 ...
 6b2:	2b290913          	addi	s2,s2,690 # 960 <malloc+0x16c>
        while(*s != 0){
...
free(void *ap)
{
 ...
 77a:	20a7b783          	ld	a5,522(a5) # 980 <freep>
 ...
 7a8:	00e6ea63          	bltu	a3,a4,7bc <free+0x50>
{
 ...
 7ea:	18f73d23          	sd	a5,410(a4) # 980 <freep>
}
 7ee:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 81c:	16853503          	ld	a0,360(a0) # 980 <freep>
 ...
 844:	14090913          	addi	s2,s2,320 # 980 <freep>
  if(p == (char*)-1)
 848:	5afd                	li	s5,-1
 84a:	a88d                	j	8bc <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 84c:	00000797          	auipc	a5,0x0
 850:	13c78793          	addi	a5,a5,316 # 988 <base>
 854:	00000717          	auipc	a4,0x0
 858:	12f73623          	sd	a5,300(a4) # 980 <freep>
 85c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 87e:	10a73323          	sd	a0,262(a4) # 980 <freep>
      return (void*)(p + 1);
 ...
 8cc:	b76080e7          	jalr	-1162(ra) # 43e <sbrk>
  if(p == (char*)-1)
