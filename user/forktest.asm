...
forktest(void)
{
  ...
  3e:	40e50513          	addi	a0,a0,1038 # 448 <set_cpu+0xc>
  ...
  68:	3f450513          	addi	a0,a0,1012 # 458 <set_cpu+0x1c>
  ...
  98:	310080e7          	jalr	784(ra) # 3a4 <wait>
  ...
  aa:	2fe080e7          	jalr	766(ra) # 3a4 <wait>
  ae:	57fd                	li	a5,-1
  ...
  b8:	3f450513          	addi	a0,a0,1012 # 4a8 <set_cpu+0x6c>
  ...
  d4:	3a850513          	addi	a0,a0,936 # 478 <set_cpu+0x3c>
  d8:	00000097          	auipc	ra,0x0
  dc:	f28080e7          	jalr	-216(ra) # 0 <print>
      exit(1);
  e0:	4505                	li	a0,1
  e2:	00000097          	auipc	ra,0x0
  e6:	2ba080e7          	jalr	698(ra) # 39c <exit>
    print("wait got too many\n");
  ea:	00000517          	auipc	a0,0x0
  ee:	3a650513          	addi	a0,a0,934 # 490 <set_cpu+0x54>
  f2:	00000097          	auipc	ra,0x0
  f6:	f0e080e7          	jalr	-242(ra) # 0 <print>
    exit(1);
  fa:	4505                	li	a0,1
  fc:	00000097          	auipc	ra,0x0
 100:	2a0080e7          	jalr	672(ra) # 39c <exit>
