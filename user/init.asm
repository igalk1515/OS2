...
main(void)
{
  ...
  4c:	326080e7          	jalr	806(ra) # 36e <fork>
  50:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  5e:	324080e7          	jalr	804(ra) # 37e <wait>
      if(wpid == pid){
  ...
  c2:	2b8080e7          	jalr	696(ra) # 376 <exit>
      exec("sh", argv);
  ...
  f4:	286080e7          	jalr	646(ra) # 376 <exit>
